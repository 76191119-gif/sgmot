...
export default function Modal({ open, onClose, title, children, maxWidth = 'max-w-2xl' }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      {/* Panel */}
      <div
        className={`cyber-glass relative w-full ${maxWidth} max-h-[90vh] flex flex-col rounded-2xl border border-[#22304A] overflow-hidden text-matrix-text`}
        style={{
          boxShadow: '0 25px 70px rgba(0,0,0,0.55), 0 0 0 1px rgba(57,255,20,0.08)',
        }}
      >
        {/* Header */}
        <div className="flex items-center justify-between px-6 py-4 border-b border-[#22304A] bg-black/40">
